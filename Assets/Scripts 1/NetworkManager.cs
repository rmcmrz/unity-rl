...
public class NetworkManager : MonoBehaviour 
{
    ...
    private GameObject learningAgent;
	...
	void Start()
	{
        ...
        learningAgent = GameObject.Find("GreenAgent");

        agentBehaviourScript = learningAgent.GetComponent<AgentBehaviourRemote>();
	...
	void loginSuccess(SocketIOEvent e)
	{
        ...
        double[] stateVector = agentBehaviourScript.getStateVector();
