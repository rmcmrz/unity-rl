...
namespace Apex.Steering.Behaviours
{
    ...
    public class AgentBehaviour : ExtendedMonoBehaviour, IHandleMessage<UnitNavigationEventMessage>
    {
	...
	*/
        ...
        */
        ...
        private void Awake()
        {
            ...
            previousStatePositionVector = new double[vectorSize];
        ...
        void IHandleMessage<UnitNavigationEventMessage>.Handle(UnitNavigationEventMessage message)
        {
			...
			if (message.eventCode == UnitNavigationEventMessage.Event.DestinationReached || message.eventCode == UnitNavigationEventMessage.Event.StoppedNoRouteExists) {
...
*/
		...
		private GameObject[] getRaycast(int maxDistance)
		{
